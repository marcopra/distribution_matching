"""Evaluate a saved ROVER encoder on salient Pong episode clips.

Requires a snapshot and saved salient episodes; writes t-SNE plots and
embedding-quality summaries to tests/outputs/encoders/pong_encoder_results.
"""
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='tests/outputs/encoders/pong_encoder_results',
