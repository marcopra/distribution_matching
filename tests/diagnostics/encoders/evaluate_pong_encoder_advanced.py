"""Run advanced Pong encoder diagnostics.

Requires salient Pong episode clips; writes alignment, uniformity, probing, and
intrinsic-dimension outputs to tests/outputs/encoders/pong_encoder_advanced_results.
"""
...
# Add repository root to import gym_env and shared diagnostics.
...
from tests.diagnostics.encoders.evaluate_pong_encoder_embeddings import EncoderTester
...
def main():
    ...
    parser.add_argument('--episodes_dir', type=str, default='tests/outputs/atari/salient_episodes_pong',
                       help='Directory episodi')
    parser.add_argument('--save_dir', type=str, default='tests/outputs/encoders/pong_encoder_advanced_results',
