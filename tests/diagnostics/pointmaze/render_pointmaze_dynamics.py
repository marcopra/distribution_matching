"""Render PointMaze dynamics and pretrain observation videos.

Uses PointMaze environment/pretrain configs and writes MP4 diagnostics under
tests/outputs/pointmaze by default.
"""
...
def parse_args():
    ...
    parser.add_argument("--output", type=Path, default=Path("tests/outputs/pointmaze/direct_velocity_test.mp4"))
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path("tests/outputs/pointmaze/pretrain_discrete_render.mp4"),
    )
    parser.add_argument(
        "--pretrain-stacked-output",
        type=Path,
        default=Path("tests/outputs/pointmaze/pretrain_discrete_framestack.mp4"),
    )
    parser.add_argument(
        "--max-velocity",
        type=float,
