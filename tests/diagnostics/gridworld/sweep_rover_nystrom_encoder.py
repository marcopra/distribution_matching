...
python tests/diagnostics/gridworld/sweep_rover_nystrom_encoder.py \
    --dataset tests/outputs/gridworld/multiplerooms_states \
    --output-dir tests/outputs/gridworld/nystrom_debug_states_s100_l2_prova \
...
python tests/diagnostics/gridworld/sweep_rover_nystrom_encoder.py \
    --dataset tests/outputs/gridworld/multiplerooms_states \
    --output-dir tests/outputs/gridworld/rank_test \
    --feature-dims 109\
    --curl-weights 0.0 \
    --encoder-update-mode nystrom \
    --dyn-loss distance_positive_only \
...
python tests/diagnostics/gridworld/sweep_rover_nystrom_encoder.py \
    --dataset tests/outputs/gridworld/multiplerooms_states \
    --output-dir tests/outputs/gridworld/full_debug_states \
