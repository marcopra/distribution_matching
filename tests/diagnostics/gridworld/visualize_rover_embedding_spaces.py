...
Examples
--------
python tests/diagnostics/gridworld/visualize_rover_embedding_spaces.py \
    --dataset tests/outputs/gridworld/multiplerooms_states \
    --output-dir tests/outputs/gridworld/embedding_space_debug \
    --feature-dims 2 3 \
...
import utils
from tests.diagnostics.gridworld.sweep_rover_nystrom_encoder import (
    DYN_LOSS_CHOICES,
    build_agent,
    compose_cfg,
