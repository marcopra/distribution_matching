"""Inspect saved salient Pong clips before encoder diagnostics.

Reads clips from tests/outputs/atari/salient_episodes_pong by default and
prints episode/action/statistics summaries without writing persistent outputs.
"""
