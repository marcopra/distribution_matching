"""Sample salient Pong clips for encoder diagnostics.

Runs a Pong environment, detects useful events, and writes NPZ/MP4 clips to
tests/outputs/atari/salient_episodes_pong by default.
"""
...
class SalientEpisodeSampler:
    ...
    def __init__(self, env, save_dir='tests/outputs/atari/salient_episodes_pong', window_size=60, buffer_size=200):
        """
        Args:
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='tests/outputs/atari/salient_episodes_pong',
