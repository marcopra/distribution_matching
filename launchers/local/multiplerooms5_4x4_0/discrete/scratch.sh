...
CUDA_DEVICE=${1:-0}
python train.py --config-name=train/finetune env=multiplerooms5_4x4_0 device=cuda:${CUDA_DEVICE} wandb_tag=from_scratch num_train_frames=50_000 seed=0
python train.py --config-name=train/finetune env=multiplerooms5_4x4_0 device=cuda:${CUDA_DEVICE} wandb_tag=from_scratch num_train_frames=50_000 seed=1
python train.py --config-name=train/finetune env=multiplerooms5_4x4_0 device=cuda:${CUDA_DEVICE} wandb_tag=from_scratch num_train_frames=50_000 seed=2
