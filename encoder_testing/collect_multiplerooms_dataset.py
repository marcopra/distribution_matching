...
Examples
--------
python encoder_testing/collect_multiplerooms_dataset.py \
    --n-samples 50000 \
    --obs-mode pixels \
    --output-dir encoder_testing/outputs/multiplerooms_pixels

python encoder_testing/collect_multiplerooms_dataset.py \
    --n-samples 4096 \
    --obs-mode discrete_states \
    --seed 7 \
    --output-dir encoder_testing/outputs/multiplerooms_states
"""
