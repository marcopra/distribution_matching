...
class DistMatchingAgent:
    def __init__(self,
        ...
        print(f"Number of states: {self.n_states}, Number of actions: {self.n_actions}")
    ...
    def init_meta(self):
        ...
        if self.initial_distribution is None:
            ...
            if self.learn_T:
                raise NotImplementedError("World model learning not implemented yet.")
            else:
    ...
    def update_transition_matrix(self, batch_of_staff):
        pass
    ...
    def update(self, replay_iter, step):
        ...
        if self.learn_T:
            ...
            metrics.update(self.update_transition_matrix(
