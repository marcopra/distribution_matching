...
class SACAgent(Agent):
    ...
    def __init__(self,  
        ...
        # models
        if obs_type == 'pixels':
            raise NotImplementedError("Pixel observations not supported yet in SACDiscrete, modify act method accordingly. Also the updates of the encoder")
    ...
    def act(self, obs, meta, step, eval_mode):
        ...
        # obs = self.encoder(self.aug(obs.unsqueeze(0))) # TODO check if augmentation is needed here
        obs = obs.unsqueeze(0)
        with torch.no_grad():
